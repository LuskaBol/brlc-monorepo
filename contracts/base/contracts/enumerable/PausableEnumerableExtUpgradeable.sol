...
import { IPausableExtUpgradeable } from "../interfaces/IPausableExtUpgradeable.sol";

/**
 * @title PausableEnumerableExtUpgradeable base contract
 * @author CloudWalk Inc. (See https://www.cloudwalk.io)
 * @dev Extends the OpenZeppelin's {PausableUpgradeable} contract by adding the {PAUSER_ROLE} role and implementing
 *      the external pausing and unpausing functions. Uses enumerable access control.
 */
abstract contract PausableEnumerableExtUpgradeable is
    AccessControlEnumerableExtUpgradeable,
    PausableUpgradeable,
    IPausableExtUpgradeable
{
    // ------------------ Constants ------------------------------- //
     ...
     */
    function __PausableEnumerableExt_init_unchained() internal onlyInitializing {
