...
import { PausableEnumerableExtUpgradeable } from "../PausableEnumerableExtUpgradeable.sol";

/**
 * @title PausableEnumerableExtUpgradeableMock contract
 * @author CloudWalk Inc. (See https://www.cloudwalk.io)
 * @dev An implementation of the {PausableEnumerableExtUpgradeable} contract for test purposes.
 */
contract PausableEnumerableExtUpgradeableMock is PausableEnumerableExtUpgradeable, UUPSUpgradeable {
    // ------------------ Initializers ---------------------------- //
