...
import { IRescuableUpgradeable } from "../interfaces/IRescuableUpgradeable.sol";

/**
 * @title RescuableEnumerableUpgradeable base contract
 * @author CloudWalk Inc. (See https://www.cloudwalk.io)
 * @dev Allows rescuing ERC20 tokens locked in the contract using the {RESCUER_ROLE} role.
 *      Uses enumerable access control.
 */
abstract contract RescuableEnumerableUpgradeable is AccessControlEnumerableExtUpgradeable, IRescuableUpgradeable {
    // ------------------ Types ----------------------------------- //
     ...
     */
    function __RescuableEnumerable_init_unchained() internal onlyInitializing {
