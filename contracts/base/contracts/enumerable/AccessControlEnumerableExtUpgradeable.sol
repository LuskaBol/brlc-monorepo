...
import { IAccessControlExtUpgradeable } from "../interfaces/IAccessControlExtUpgradeable.sol";

/**
 * @title AccessControlEnumerableExtUpgradeable base contract
 ...
 */
abstract contract AccessControlEnumerableExtUpgradeable is
    AccessControlEnumerableUpgradeable,
    IAccessControlExtUpgradeable
{
    // ------------------ Constants ------------------------------- //
     ...
     */
    function __AccessControlEnumerableExt_init_unchained() internal onlyInitializing {
